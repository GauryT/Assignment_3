...
pygame.display.set_caption('Tank Warlords')

# Load and set the icon
icon = pygame.image.load('resources/resources/images/intro/icon.png') 
...
#load images
bg_img = pygame.image.load('resources/resources/images/grassbg2.png')
bg_img = pygame.transform.scale(bg_img, (1000, 700))
rocket_img = pygame.image.load(f'resources/resources/images/rocket/1.png')
detial_img = pygame.image.load('resources/resources/images/detials.png')
bc_img = pygame.image.load('resources/resources/images/intro/bc.png')
ps_img = pygame.image.load('resources/resources/images/intro/ps.png')
co_img = pygame.image.load('resources/resources/images/intro/co.png')
control_img = pygame.image.load('resources/resources/images/intro/control.png')
pause_img = pygame.image.load('resources/resources/images/intro/pause.png')
re_img = pygame.image.load('resources/resources/images/intro/resume.png')
qg_img = pygame.image.load('resources/resources/images/intro/qg.png')
rest_img = pygame.image.load('resources/resources/images/intro/rest.png')
score_img = pygame.image.load('resources/resources/images/intro/score.png')
pl_img = []
for i in range(1,3):
    img = pygame.image.load(f'resources/resources/images/player1/lv1/right/{i}.png')
    pl_img.append(img)

#load sounds
# tank move sound
tank_move = mixer.Sound('resources/resources/sound/move.ogg')
tank_move.set_volume(0.0)
tank_move.play(-1)

# bonus sound
bonus = pygame.mixer.Sound('resources/resources/sound/bonus.ogg')
bonus.set_volume(0.9)

# tank blast sound
tank_blast = pygame.mixer.Sound('resources/resources/sound/explosion.ogg')
tank_blast.set_volume(0.9)

# tank fire sound
tank_fire = pygame.mixer.Sound('resources/resources/sound/fire.ogg')
tank_fire.set_volume(0.9)

# brick sound
brick = pygame.mixer.Sound('resources/resources/sound/brick.ogg')
brick.set_volume(0.9)

# gamestart sound
gamestart = pygame.mixer.Sound('resources/resources/sound/gamestart.ogg')
gamestart.set_volume(0.9)

# gameover sound
gameover = pygame.mixer.Sound('resources/resources/sound/gameover.ogg')
gameover.set_volume(0.9)

# score sound
score = pygame.mixer.Sound('resources/resources/sound/score.ogg')
score.set_volume(0.9)

# steel sound
steel = pygame.mixer.Sound('resources/resources/sound/steel.ogg')
steel.set_volume(0.9)

# rocket_blast sound
rblast = pygame.mixer.Sound('resources/resources/sound/rblast.wav')
rblast.set_volume(0.9)

# high score sound
hg = pygame.mixer.Sound('resources/resources/sound/hg.mp3')
hg.set_volume(0.9)
...
class Tank(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, direction, level, health, speed):
        ...
        self.action = 0
        if char_type != "player1" :
        # and char_type != "player2" and char_type != "player3" and char_type != "player4"
            self.action = 1
            self.direction = -2
            self.lifes = 1
        self.frame_index = 0
        ...
        self.tank_blast = []
        for i in range(1, len(os.listdir(f'resources/resources/images/tank_blast'))+1):
            img = pygame.image.load(f"resources/resources/images/tank_blast/{i}.png")
            self.tank_blast.append(img)
        self.image_blast = self.tank_blast[0]

        # load tank shiled images
        self.tank_shiled = []
        for i in range(1, len(os.listdir(f'resources/resources/images/shiled'))+1):
            img = pygame.image.load(f"resources/resources/images/shiled/{i}.png")
            self.tank_shiled.append(img)
        self.image_shiled = self.tank_shiled[0]

        # load tank spawn images
        self.tank_spawn = []
        for i in range(1, len(os.listdir(f'resources/resources/images/tank_spawn'))+1):
            img = pygame.image.load(f"resources/resources/images/tank_spawn/{i}.png")
        ...
        for animation_index in range(1,5):
            ...
            for animation in animation_types:
                ...
                if char_type != "player1" :
                    num_of_frames = len(os.listdir(f'resources/resources/images/enemy/{"lv"+str(animation_index)}/{animation}'))
                else:
                    num_of_frames = len(os.listdir(f'resources/resources/images/{self.char_type}/{"lv"+str(animation_index)}/{animation}'))
                for i in range(1,num_of_frames+1):
                    if char_type != "player1" :
                        img = pygame.image.load(f"resources/resources/images/enemy/{'lv'+str(animation_index)}/{animation}/{i}.png")
                    else:
                        img = pygame.image.load(f"resources/resources/images/{self.char_type}/{'lv'+str(animation_index)}/{animation}/{i}.png")
            ...
            for tile in world.tile_list:
                if self.vision.colliderect(tile[1]):
                    ...
                    if (tile[2]=='s' and self.fire_power >= 2):
                        self.enemy_shoot()
                    if tile[2]=='e' and (self.char_type != "player1" ):
                        if tile[3]!=1:
                            self.enemy_shoot()
...
class Wall_blast(pygame.sprite.Sprite):
    def __init__(self, x, y, direction, tile_remove):
        ...
        self.rocket_boom = []
        for i in range(len(os.listdir("resources/resources/images/rocket_boom"))):
            img = pygame.image.load(f"resources/resources/images/rocket_boom/{i}.png")
...
class Power_up(pygame.sprite.Sprite):
    def __init__(self, data):
        ...
        for i in os.listdir("resources/resources/images/powerup"):
            img = pygame.image.load(f"resources/resources/images/powerup/{i}")
...
class World():
    def __init__(self, data):
        ...
        #map images load
        self.img_ = pygame.image.load(f"resources/resources/images/powerup/zzz.png")
        self.boarder = pygame.image.load('resources/resources/images/boarder.png')
        self.grass=pygame.image.load("resources/resources/images/grass/1.png")
        self.speed_tiled=pygame.image.load("resources/resources/images/speed_tiled/1.png")

        self.stell_wall = []
        self.stell_wall_index = 0
        for i in range(1, len(os.listdir("resources/resources/images/stell_wall"))+1):
            img = pygame.image.load(f"resources/resources/images/stell_wall/{i}.png")
            self.stell_wall.append(img)

        self.brick_wall = []
        self.brick_wall_index = 0
        for i in range(1, len(os.listdir("resources/resources/images/brick_wall"))+1):
            img = pygame.image.load(f"resources/resources/images/brick_wall/{i}.png")
            self.brick_wall.append(img)

        self.water = []
        self.water_index = 0
        for i in range(1, len(os.listdir("resources/resources/images/water"))+1):
            img = pygame.image.load(f"resources/resources/images/water/{i}.png")
            self.water.append(img)

        self.eagle = []
        self.eagle_index = 0
        for i in range(1, len(os.listdir("resources/resources/images/eagle"))+1):
            img = pygame.image.load(f"resources/resources/images/eagle/{i}.png")
            self.eagle.append(img)

        self.eagle_boom = []
        self.eagle_boom_index = 0
        for i in range(1, len(os.listdir("resources/resources/images/boom"))+1):
            img = pygame.image.load(f"resources/resources/images/boom/{i}.png")
...
class Detials():
    def __init__(self):
        ...
        for i in range(1, len(os.listdir("resources/resources/images/intro/hs"))+1):
            img = pygame.image.load(f"resources/resources/images/intro/hs/{i}.png")
            self.high_sc.append(img)

        self.high_no = []
        self.high_no_index = 0
        for i in range(0, len(os.listdir("resources/resources/images/intro/no"))):
            img = pygame.image.load(f"resources/resources/images/intro/no/{i}.png")
            self.high_no.append(img)

        self.high_no1 = []
        self.high_no_index1 = 0
        for i in range(0, len(os.listdir("resources/resources/images/intro/no1"))):
            img1 = pygame.image.load(f"resources/resources/images/intro/no1/{i}.png")
        ...
        for i in range(1, 5):
            self.temp_lst = []
            for j in range(1, 3):
                self.pl_img = pygame.image.load(f"resources/resources/images/player{i}/lv1/up/{j}.png")
                self.temp_lst.append(self.pl_img)
            self.pl_image_lst.append(self.temp_lst)
        self.pl_image = self.pl_image_lst[0][0]

        self.score_img = pygame.image.load('resources/resources/images/intro/score.png')
        self.score_txt_img = pygame.image.load('resources/resources/images/intro/sc.png')
...
class Game_over():
    def __init__(self):
        self.go_img = pygame.image.load('resources/resources/images/intro/go.png')
        self.speed = 1
        self.fade_counter = 0
        self.update_time = pygame.time.get_ticks()
        self.finish = False
